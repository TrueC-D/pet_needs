class Pet < ApplicationRecord
  ...
  def self.needs_terrarium
    self.a_pet.merge({"Clean Terrarium" => "It is hygienic and best for your pet's health if your Terrarium is clean",
  ...
  def self.land_animal
    self.a_pet.merge({'Give Water' => "Pets that don't live in water need to drink water to stay hydrated."})
  end
